...
const telanganaBanner = new URL(
  "../assets/states/Telangana.jpg",
  import.meta.url
).href;

const modules = import.meta.glob(
  "../assets/telangana/**/*.{jpg,jpeg,png,webp}",
  {
    eager: true,
    import: "default",
  }
...
Object.entries(modules).forEach(([path, src]) => {
  ...
  const split = p.split("/telangana/")[1];
  if (!split) return;
...
export const Telangana: React.FC = () => {
  return (
      ...
      <div className="relative w-full h-[360px] overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-full text-center text-white px-6">
          ...
          <p className="mt-5 text-lg md:text-xl max-w-3xl">
            Discover forts, temples, lakes, waterfalls & culture
          </p>
        </div>
      </div>
...
export const TelanganaDistrictPage: React.FC = () => {
